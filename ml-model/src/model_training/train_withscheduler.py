...
'''
arcface_loss_fn = engine.ArcFaceLoss(s=30.0, m=0.5)

# Train the classifier head with adaptive learning rate and early stopping
set_seeds()
pretrained_vit_results = engine.train_with_arcface(
    ...
    epochs=40,
    device=device,
    checkpoint_dir='checkpoint_with_arcface'
)
'''
# Train the classifier head with adaptive learning rate and early stopping
set_seeds()
pretrained_vit_results = engine.train_with_early_stopping(
    model=pretrained_vit,
    train_dataloader=train_dataloader_pretrained,
    test_dataloader=test_dataloader_pretrained,
    optimizer=optimizer,
    ...
    epochs=40,
    device=device,
    checkpoint_dir='checkpoint_with_early_stopping_64batch'
)
